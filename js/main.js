...
var pst_w = {
    'p': pst_b['p'].slice().reverse(),
    'n': pst_b['n'].slice().reverse(),
    'b': pst_b['b'].slice().reverse(),
    'r': pst_b['r'].slice().reverse(),
    'q': pst_b['q'].slice().reverse(),
    'k': pst_b['k'].slice().reverse(),
    'k_e': pst_b['k_e'].slice().reverse()
}
...
function SelectGame(a){
    ...
    if(a=="sicillain"){
        reset();
        game.load('rnbqkbnr/pp2pppp/3p4/2p5/3PP3/5N2/PPP2PPP/RNBQKB1R b KQkq - 0 3');
        board.position(game.fen());
        window.setTimeout(function() {makeBestMove('b')}, 250)
    }
    if(a=="nes"){
        reset();
        game.load('r1bqkbnr/ppp2ppp/2n5/3pp3/5P2/6K1/PPPPP1PP/RNBQ1BNR b kq - 0 4');
        board.position(game.fen());
        window.setTimeout(function() {makeBestMove('b')}, 250)
    }
    if(a=="bong"){
        reset();
    game.load('rnbqkbnr/pppp1ppp/8/4p3/4P3/8/PPPPKPPP/RNBQ1BNR b kq - 1 2');
    board.position(game.fen());
    window.setTimeout(function() {makeBestMove('b')}, 250)
    }
    if(a=="monkey"){
        reset();
    game.load('rnbqk1nr/pppp1pbp/4p1p1/8/2B1P3/1N3Q2/PPP2PPP/R1B1K1NR b KQkq - 3 6');
    board.position(game.fen());
    window.setTimeout(function() {makeBestMove('b')}, 250)
    }
    if(a=="toilet"){
        reset();
    game.load('rnbqkbnr/pp2pppp/8/2pp4/4PP2/2N5/PPPP2PP/R1BQKBNR b KQkq - 1 3');
    board.position(game.fen());
    window.setTimeout(function() {makeBestMove('b')}, 250)
    }
    if(a=="carokann"){
    ...
    if(a=="queenaccept"){
        reset();
    game.load('rnbqkbnr/ppp1pppp/8/8/2pP4/8/PP2PPPP/RNBQKBNR w KQkq - 0 3');
    board.position(game.fen());
    }
    if(a=="french"){
        reset();
    game.load('rnbqkbnr/ppp2ppp/4p3/3p4/3PP3/8/PPP2PPP/RNBQKBNR w KQkq - 0 3');
    board.position(game.fen());
    ...
    if(a=="scand"){
        reset();
    game.load('rnbqkbnr/ppp1pppp/8/3p4/4P3/8/PPPP1PPP/RNBQKBNR w KQkq - 0 2');
    board.position(game.fen());
   
    }
    if(a=="kingsgambit"){
        reset();
    game.load('rnbqkbnr/pppp1ppp/8/4p3/4PP2/8/PPPP2PP/RNBQKBNR b KQkq - 0 2');
    board.position(game.fen());
    window.setTimeout(function() {makeBestMove('b')}, 250)
    }
    if(a=="vienna"){
        reset();
    game.load('rnbqkbnr/pppp1ppp/8/4p3/4P3/2N5/PPPP1PPP/R1BQKBNR b KQkq - 1 2');
    board.position(game.fen());
    window.setTimeout(function() {makeBestMove('b')}, 250)
    }
    if(a=="scotch"){
        reset();
    game.load('r1bqkbnr/pppp1ppp/2n5/4p3/3PP3/5N2/PPP2PPP/RNBQKB1R b KQkq - 0 3');
    board.position(game.fen());
    window.setTimeout(function() {makeBestMove('b')}, 250)
    }
    if(a=="alekhine"){
        reset();
    game.load('rnbqkb1r/pppppppp/5n2/8/4P3/8/PPPP1PPP/RNBQKBNR w KQkq - 1 2');
    board.position(game.fen());
    
    }
    if(a=="pirc"){
        reset();
    game.load('rnbqkb1r/ppp1pppp/3p1n2/8/3PP3/8/PPP2PPP/RNBQKBNR w KQkq - 1 3');
    board.position(game.fen());
    }
    if(a=="slav"){
        reset();
